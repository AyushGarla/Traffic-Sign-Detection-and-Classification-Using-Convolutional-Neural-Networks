...
path = "F:\MS\SRH_study\IV_sem\THESIS\Traffic_sign_detection\Traffic_sign_detection_cnn\Traffic_signs\Data"  # folder with all the class folders
labelFile = 'F:\MS\SRH_study\IV_sem\THESIS\Traffic_sign_detection\Traffic_sign_detection_cnn\Traffic_signs\labels.csv'  # file with all names of classes
